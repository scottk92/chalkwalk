...
coordsDB.push({'name':'B', 'lat':37.425627, 'lng':-122.167453, 'color':'#F2D43F'});
coordsDB.push({'name':'B', 'lat':37.425220, 'lng':-122.168474, 'color':'#F2D43F'});
coordsDB.push({'name':'B', 'lat':37.425471, 'lng':-122.169187, 'color':'#F2D43F'});
coordsDB.push({'name':'B', 'lat':37.425041, 'lng':-122.170056, 'color':'#F2D43F'});
